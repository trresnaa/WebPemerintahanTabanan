...
<body>
    ...
    <div class="container">
        <br>
        <h3 class="text-center">Tambah Bidang</h3>
        <br>
        <form action="bidang_tambah_proses.php" method="post" enctype="multipart/form-data">
            <div class="mb-3 row">
                <label for="kode_bidang" class="col-sm-2 col-form-label">Kode Bidang</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kode_bidang" name="kode_bidang" maxlength="50">
                </div>
            </div>
            <div class="mb-3 row">
