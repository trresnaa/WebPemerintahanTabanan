...
<body>
    ...
    <div class="container">
        <br>
        <h3 class="text-center">Formulir Edit Dokumen Laporan</h3>
        <br>
        <?php
            $id = $_GET['id'];
        ...
        <form id="uploadForm" action="upload_edit_proses.php" method="post" enctype="multipart/form-data">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?= $row['judul_dokumen'] ?>" id="judul" name="judul" required>
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <a href="upload/<?= $row['nama_file'] ?>" target="_blank"><?= $row['judul_dokumen'] ?></a>
